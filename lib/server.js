...
const apiRoutes = {
  helpText:
    'This is a lightweight API for using when learning how to build a Zapier CLI app. Only GET requests are allowed. All requiredData is assumed to be query params.',
  endpoints: {
    spreadsheet: {
